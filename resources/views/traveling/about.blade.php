            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="content">
                        ...
                        <h2>Welcome To {{ $counties->name }}</h2>
                        <p>{{ $counties->description }}</p>
        ...
        <div class="container bg-white">
            <div class="row">
                <div class="slider-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-black">{{ $counties->name }}’s <em>Cities &amp; Towns</em></h2>
                        </div>
                        <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            <div class="info-item">
                                <div class="row">
                                    ...
                                    {{-- <div class="col-lg-6">
                                        <h4 class="text-black">240.580+</h4>
